...
class Controller():
   ...
   def advanceSnake(self, nextCell):
       ...
       # If we eat food, update the state of the board
           ...
           self.playSound_eat()
           self.__data.growSnakeForward(nextCell) # <--- Call your new growth helper


       # If the cell is empty, just move forward normal
       elif nextCell.isEmpty():
           self.__data.moveSnakeForward(nextCell) # <--- Call your new normal movement helper
